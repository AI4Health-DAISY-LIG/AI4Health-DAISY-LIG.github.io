...
export default function FindUsPage() {
  return (
    <section className="flex min-h-[86.5vh] flex-col items-center justify-center px-2 py-8 text-center">
      ...
      <p className="max-w-2xl mx-auto mt-2">Are you a professional in the biomedical field? A researcher or an engineer interested in developing new data sources or improving existing ones? 
      ...
      <h2 className="mt-10 text-2xl font-semibold">Visit the LIGLAB</h2>
